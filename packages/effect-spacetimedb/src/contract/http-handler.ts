...
> = {
  ...
  readonly path: Path
  // Presence-sensitive absent markers: Object.hasOwn distinguishes raw handlers from typed handlers.
...
> = {
  readonly method: Method
  readonly path: Path
  // Presence-sensitive absent markers: Object.hasOwn distinguishes procedure handlers from typed handlers.
  readonly request?: undefined
  readonly response?: undefined
  readonly errors?: undefined
  readonly successStatus?: number
