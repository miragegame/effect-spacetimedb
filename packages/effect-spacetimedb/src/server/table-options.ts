// lint-ignore: use-exhaustive-discriminant-chain - server view context branch is checked at contract construction.
import * as Match from "effect/Match"
import { canonicalNameForPolicy } from "../contract/canonical-name.ts"
import type { IndexAlgorithm } from "../contract/index.ts"
