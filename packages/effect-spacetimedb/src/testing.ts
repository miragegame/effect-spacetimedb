// lint-ignore: unused-exports - package export map exposes these curated testing helpers.
...
export * as ClientTransportCodec from "./client/value-codec.ts"
...
export * as ContractTypeSats from "./contract/type/sats.ts"
...
const testingEntrypoint = "effect-spacetimedb/testing" as const
void testingEntrypoint
