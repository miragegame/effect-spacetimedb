...
export const isGroupImpl = (impl: AnyBuilderImpl): impl is AnyGroupImpl =>
  isRecordLike(impl) && "groupName" in impl

export const isLifecycleImpl = (
  impl: AnyBuilderImpl,
): impl is AnyLifecycleImpl => {
...
export const assertImplBelongsToModule = (
...
export const collectLifecycleSpecs = (
...
export const moduleSpecWithLifecycle = <
