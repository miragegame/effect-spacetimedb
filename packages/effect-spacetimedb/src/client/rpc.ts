...
type PublicReducerKeys<Module extends AnyModuleSpec> = {
...
type PublicProcedureKeys<Module extends AnyModuleSpec> = {
...
type HttpHandlerKeys<Module extends AnyModuleSpec> =
...
type ReducerRpcFunction<Spec extends ReducerSpec, R> = ((
  payload: ParamsOf<Spec>,
) => Effect.Effect<void, CallFailure<DeclaredErrorsOf<Spec>>, R>) & {
  readonly raw: (
    payload: ParamsOf<Spec>,
...
type ProcedureRpcFunction<Spec extends ProcedureSpec, R> = ((
  payload: ParamsOf<Spec>,
) => Effect.Effect<ReturnsOf<Spec>, CallFailure<DeclaredErrorsOf<Spec>>, R>) & {
  readonly raw: (
    payload: ParamsOf<Spec>,
