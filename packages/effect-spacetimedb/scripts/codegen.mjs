// lint-ignore: prefer-effect-filesystem - Standalone codegen runs as a plain Node script.
import {
  cpSync,
  existsSync,
  lstatSync,
...
const resolveBiomeBinaryPath = () => {
  ...
  throw new Error(
    `Biome binary not found at ${packageBiomeBinaryPath} or ${installRootBiomeBinaryPath}. Run bun install from the package, mirror root, or workspace root.`,
  )
}
