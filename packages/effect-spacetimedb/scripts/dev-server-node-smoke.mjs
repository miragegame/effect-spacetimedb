...
const resolveTscPath = () => {
  ...
  throw new Error(
    `tsc binary not found at ${packageTscPath} or ${installRootTscPath}. Run bun install from the package or repository root.`,
  )
}
...
try {
  ...
  cpSync(
    join(packageRoot, "examples", "publishable-module", "generated-client"),
    join(compiledRoot, "examples", "publishable-module", "generated-client"),
    { recursive: true },
  )
    ...
    JSON.stringify(
      {
        ...
        exports: {
          ...
          "./testing/example-client":
            "./examples/publishable-module/src/client-bindings.js",
