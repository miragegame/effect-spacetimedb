// lint-ignore: stdb-string-columns-require-domain, stdb-numeric-columns-require-domain - captured transport replay fixtures intentionally model a narrow SDK module.
