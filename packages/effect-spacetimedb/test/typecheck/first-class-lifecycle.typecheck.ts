...
const InvalidLifecycleDeclarationHook = Stdb.StdbModule.make(
  ...
  {
    lifecycle: {
      // @ts-expect-error lifecycle declarations must match their record key.
...
const InvalidLifecycleDeclarationDecl = Stdb.StdbModule.make(
  "invalid_lifecycle_declaration_decl",
  {
    lifecycle: {
      // @ts-expect-error lifecycle declarations must match their record key.
      clientDisconnected: Stdb.StdbFn.init(),
...
void InvalidLifecycleDeclarationDecl
