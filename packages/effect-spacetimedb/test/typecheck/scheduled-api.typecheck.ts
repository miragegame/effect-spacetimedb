// lint-ignore: stdb-string-columns-require-domain, stdb-numeric-columns-require-domain - typecheck fixture intentionally exercises raw STDB schema constructors
