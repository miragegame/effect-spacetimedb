// lint-ignore: stdb-string-columns-require-domain, stdb-numeric-columns-require-domain - interop typecheck fixture intentionally exercises raw STDB schema constructors
