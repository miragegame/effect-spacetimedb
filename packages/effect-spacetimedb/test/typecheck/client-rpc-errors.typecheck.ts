...
type GroupedHttpProcedureError = ErrorOf<
  ReturnType<typeof http.FullCallables.procedures.userGet>
>
...
>
type _GroupedHttpProcedureError = Assert<
  IsEqual<
    DirectDomainErrorOf<GroupedHttpProcedureError>,
