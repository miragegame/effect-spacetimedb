// lint-ignore: stdb-string-columns-require-domain, stdb-numeric-columns-require-domain - capability drift tests intentionally enumerate raw STDB schema constructors.
